...
def insert_daily_price_query(securityID, data_vendorID, date, open_price, high_price, low_price, close_price, volume):
    return f'''
        INSERT INTO {daily_price_table_name} (securityID, data_vendorID, price_date, open_price, high_price, low_price, close_price, volume)
        VALUES ({securityID}, {data_vendorID}, {date}, {open_price}, {high_price}, {low_price}, {close_price}, {volume})
    '''
